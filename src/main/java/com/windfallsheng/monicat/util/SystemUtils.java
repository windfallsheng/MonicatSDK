...
public class SystemUtils {
    ...
    public static DeviceInfo getDeviceInfo(Context context) {
        ...
        if (deviceId != null && !"".equals(deviceId)) {
            ...
            deviceInfo.setDeviceIdType(MonicatConstants.DEVICE_ID);
            return deviceInfo;
        }
        try {
        ...
        if (deviceId != null && !"".equals(deviceId)) {
            ...
            DeviceInfo deviceInfo = new DeviceInfo();
            deviceInfo.setDeviceUniqueId(deviceId);
            deviceInfo.setDeviceIdType(MonicatConstants.ANDROID_ID);
            return deviceInfo;
        }
        try {
            deviceId = getIMIE(context);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (deviceId != null && !"".equals(deviceId)) {
            ...
            DeviceInfo deviceInfo = new DeviceInfo();
            deviceInfo.setDeviceUniqueId(deviceId);
            deviceInfo.setDeviceIdType(MonicatConstants.IMEI);
            return deviceInfo;
        }
        try {
        ...
        if (deviceId != null && !"".equals(deviceId)) {
            ...
            DeviceInfo deviceInfo = new DeviceInfo();
            deviceInfo.setDeviceUniqueId(deviceId);
            deviceInfo.setDeviceIdType(MonicatConstants.Mac);
            return deviceInfo;
        }
        ...
        if (uuid != null || !"".equals(uuid)) {
            ...
            DeviceInfo deviceInfo = new DeviceInfo();
            deviceInfo.setDeviceUniqueId(deviceId);
            deviceInfo.setDeviceIdType(MonicatConstants.DEVICE_UUID);
            return deviceInfo;
        }
        return null;
    }
